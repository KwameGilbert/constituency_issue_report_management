<?php
// admin/agents/view_agent.php - View Agent Details
...
try {
    ...
    // Fetch agent's activity statistics
    $stats_sql = "
        SELECT 
    ...
    // Fetch recent issues by this agent
    $recent_issues_sql = "
    ...
    $recent_issues_stmt->execute([$agent_id]);
...
<body class="bg-slate-50 min-h-screen font-sans">
    ...
    <main class="lg:ml-64 min-h-screen transition-all duration-300">
        <?php renderAdminHeader('Agent Details', 'View agent information and activity', $headerActionButtons); ?>
        ...
        <div class="p-4 sm:p-6">
            ...
            <?php if ($agent): ?>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mb-6">
                    <div class="p-6">
                        <div class="flex items-center space-x-4 mb-6">
                            ...
                            <div class="flex-1">
                                <h1 class="text-2xl font-bold text-gray-900"><?php echo htmlspecialchars($agent['name']); ?></h1>
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center text-sm">
                                        ...
                                        <span>Joined <?php echo date('M d, Y', strtotime($agent['created_at'])); ?></span>
                                    </div>
                                    <?php if ($agent['last_login']): ?>
                                        <div class="flex items-center text-sm">
                                            <i class="fas fa-clock text-gray-400 w-5 mr-3"></i>
                                            <span>Last login <?php echo date('M d, Y H:i', strtotime($agent['last_login'])); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Recent Issues</h3>
                        
                        <?php if (empty($recent_issues)): ?>
                            <div class="text-center py-8">
                                <i class="fas fa-inbox text-gray-400 text-3xl mb-4"></i>
                                <p class="text-gray-500">No issues found for this agent</p>
                            </div>
                        <?php else: ?>
            ...
            <?php else: ?>
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-center">
                    ...
                    <p class="text-gray-600 mb-4">The agent you're looking for doesn't exist or has been removed.</p>
