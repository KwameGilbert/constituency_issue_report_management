...
// Fetch supervisor (MP) information
$supervisor_id = $_SESSION['admin_id'];
$supervisor_query = "SELECT name, office_location, position FROM supervisors WHERE id = ?";
...
$supervisor_info = $supervisor_result->fetch_assoc();
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-semibold text-gray-800">Welcome,
                        <?= htmlspecialchars($supervisor_info['name']) ?>
                    </h2>
                    <p class="text-gray-600 mt-1">
                        <?= ucfirst(htmlspecialchars($supervisor_info['position'] ?? 'MP')) ?> |
                        <?= htmlspecialchars($supervisor_info['office_location'] ?? 'Parliament House') ?>
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <a href="../issues/?status=pending"
                    ...
                    <span>
                        ...
                        <span class="block text-xs text-gray-500">Review requests</span>
                    </span>
                </a>
                ...
                <a href="../projects/"
                    ...
                    <span>
                        <span class="block text-sm font-medium">Projects</span>
                        <span class="block text-xs text-gray-500">View constituency projects</span>
                    </span>
                </a>
                ...
                <!-- <a href="../staff/"
                    ...
                    <span
                        class="inline-flex justify-center items-center w-10 h-10 rounded-full bg-purple-100 text-purple-500 mr-3">
                        <i class="fas fa-users"></i>
                    </span>
                    <span>
                        <span class="block text-sm font-medium">Staff Management</span>
                        <span class="block text-xs text-gray-500">Manage constituency staff</span>
                    </span>
                </a> -->
                ...
                <a href="../reports/"
                    ...
                    <span>
                        ...
                        <span class="block text-xs text-gray-500">Create analytics reports</span>
                    </span>
                </a>
            </div>
        </div>
