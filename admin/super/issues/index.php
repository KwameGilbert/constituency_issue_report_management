...
// Always exclude "under_review" status issues for MP Admin
$conditions[] = "i.status != 'under_review'";
...
$page_title = "Issues Management - MP Admin Portal";
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-blue-700">
                        Issues that are currently under review are not shown in this list.
                    </p>
                </div>
            </div>
        </div>
