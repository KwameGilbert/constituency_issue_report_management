...
/**
 * Returns Tailwind CSS classes for an issue status badge specifically for the table.
 * (This is kept separate for clarity if different styling is desired, but currently mirrors getStatusBadgeClasses)
 *
 * @param string $status The issue status (e.g., 'pending', 'approved', 'rejected', 'resolved').
 * @return string The CSS classes for the badge.
 */
