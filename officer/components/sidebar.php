            ...
            <nav class="p-3 flex-grow overflow-y-auto">
                ...
                <ul class="space-y-1">
                    ...
                    $menuItems = [
                        ...
                        'agents' => ['icon' => 'fas fa-users', 'label' => 'Agents'],
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <p class="text-sm font-medium text-gray-800">
                                <?php echo isset($_SESSION['user_name']) ? htmlspecialchars($_SESSION['user_name'], ENT_QUOTES, 'UTF-8') : 'Officer'; ?>
                            </p>
                            <p class="text-xs text-gray-500">
                                <?php echo isset($_SESSION['user_email']) ? htmlspecialchars($_SESSION['user_email'], ENT_QUOTES, 'UTF-8') : 'officer@example.com'; ?>
                            </p>
                        </div>
                    </div>
