<?php
// admin/officers/add_officer.php - Add New Officer
        ...
        try {
            ...
            if ($check_stmt->rowCount() > 0) {
                ...
                if ($insert_stmt->rowCount() > 0) {
                    $message = "Officer added successfully. Temporary password is the phone number.";
...
<head>
    ...
    <title>Add New Officer - Admin Dashboard</title>
...
<body class="bg-slate-50 min-h-screen font-sans">
    ...
    <main class="lg:ml-64 min-h-screen transition-all duration-300">
        <?php renderAdminHeader('Add New Officer', 'Create a new officer account', $headerActionButtons); ?>
