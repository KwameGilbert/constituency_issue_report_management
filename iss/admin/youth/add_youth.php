<?php
// admin/youth/add_youth.php - Add New Youth Record
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($validation_errors)) {
        try {
            ...
            header("Location: view_youth.php?id=$new_id&message=" . urlencode($message) . "&type=$message_type");
            exit;
        } catch (Exception $e) {
    ...
    <main class="flex-1 pb-8 px-4 sm:px-6 lg:px-8 bg-slate-50">
        ...
        <form method="POST" class="space-y-6">
                ...
                <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <input type="text" name="name" id="name" required value="<?php echo htmlspecialchars($youth['name']); ?>" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="date_of_birth" class="block text-sm font-medium text-gray-700">Date of Birth *</label>
                            <div class="mt-1">
                                <input type="date" name="date_of_birth" id="date_of_birth" required value="<?php echo htmlspecialchars($youth['date_of_birth']); ?>" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="national_id" class="block text-sm font-medium text-gray-700">National ID Number *</label>
                            <div class="mt-1">
                                <input type="text" name="national_id" id="national_id" required value="<?php echo htmlspecialchars($youth['national_id']); ?>" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="phone_number" class="block text-sm font-medium text-gray-700">Phone Number *</label>
                            <div class="mt-1">
                                <input type="tel" name="phone_number" id="phone_number" required value="<?php echo htmlspecialchars($youth['phone_number']); ?>" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="home_town" class="block text-sm font-medium text-gray-700">Home Town *</label>
                            <div class="mt-1">
                                <input type="text" name="home_town" id="home_town" required value="<?php echo htmlspecialchars($youth['home_town']); ?>" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="residential_community" class="block text-sm font-medium text-gray-700">Residential Community *</label>
                            <div class="mt-1">
                                <input type="text" name="residential_community" id="residential_community" required value="<?php echo htmlspecialchars($youth['residential_community']); ?>" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div class="sm:col-span-6">
                            <div class="relative flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="jhs_completed" name="jhs_completed" type="checkbox" <?php echo $youth['jhs_completed'] ? 'checked' : ''; ?> class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                                </div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" name="shs_qualification" id="shs_qualification" value="<?php echo htmlspecialchars($youth['shs_qualification']); ?>" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="E.g., General Arts, Science, Visual Arts, etc.">
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="certificate_qualification" class="block text-sm font-medium text-gray-700">Certificate Qualification</label>
                            <div class="mt-1">
                                <input type="text" name="certificate_qualification" id="certificate_qualification" value="<?php echo htmlspecialchars($youth['certificate_qualification']); ?>" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="diploma_qualification" class="block text-sm font-medium text-gray-700">Diploma Qualification</label>
                            <div class="mt-1">
                                <input type="text" name="diploma_qualification" id="diploma_qualification" value="<?php echo htmlspecialchars($youth['diploma_qualification']); ?>" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="first_degree" class="block text-sm font-medium text-gray-700">First Degree</label>
                            <div class="mt-1">
                                <input type="text" name="first_degree" id="first_degree" value="<?php echo htmlspecialchars($youth['first_degree']); ?>" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="E.g., BSc Computer Science, BA Economics, etc.">
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="postgraduate_qualification" class="block text-sm font-medium text-gray-700">Postgraduate Qualification</label>
                            <div class="mt-1">
                                <input type="text" name="postgraduate_qualification" id="postgraduate_qualification" value="<?php echo htmlspecialchars($youth['postgraduate_qualification']); ?>" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="E.g., MSc, MBA, PhD, etc.">
                            </div>
                        </div>
                        <div class="sm:col-span-6">
                            <label for="professional_qualification" class="block text-sm font-medium text-gray-700">Professional Qualification</label>
                            <div class="mt-1">
                                <input type="text" name="professional_qualification" id="professional_qualification" value="<?php echo htmlspecialchars($youth['professional_qualification']); ?>" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="E.g., ACCA, CIM, etc.">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                ...
                <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4">
                        <?php for ($i = 1; $i <= 6; $i++): ?>
                            <div>
                                <label for="work_experience_<?php echo $i; ?>" class="block text-sm font-medium text-gray-700">Work Experience <?php echo $i; ?></label>
                                <div class="mt-1">
                                    <textarea id="work_experience_<?php echo $i; ?>" name="work_experience_<?php echo $i; ?>" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Company name, position, duration, and key responsibilities"><?php echo htmlspecialchars($youth['work_experience_' . $i]); ?></textarea>
                                </div>
                            </div>
                        <?php endfor; ?>
                    </div>
                ...
                <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <select id="employment_status" name="employment_status" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <select id="availability_status" name="availability_status" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1">
                                <input type="text" name="current_employment" id="current_employment" value="<?php echo htmlspecialchars($youth['current_employment']); ?>" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="E.g., Teacher at ABC School">
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="preferred_work_location" class="block text-sm font-medium text-gray-700">Preferred Work Location</label>
                            <div class="mt-1">
                                <input type="text" name="preferred_work_location" id="preferred_work_location" value="<?php echo htmlspecialchars($youth['preferred_work_location']); ?>" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="E.g., Within constituency, Accra, etc.">
                            </div>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="salary_expectation" class="block text-sm font-medium text-gray-700">Salary Expectation (GHS)</label>
                            <div class="mt-1">
                                <input type="number" name="salary_expectation" id="salary_expectation" step="0.01" min="0" value="<?php echo $youth['salary_expectation'] ? htmlspecialchars($youth['salary_expectation']) : ''; ?>" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Monthly salary expectation">
                            </div>
                        </div>
                        <div class="sm:col-span-6">
                            <label for="employment_notes" class="block text-sm font-medium text-gray-700">Employment Notes</label>
                            <div class="mt-1">
                                <textarea id="employment_notes" name="employment_notes" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Additional notes about employment history, preferences, etc."><?php echo htmlspecialchars($youth['employment_notes']); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea id="skills" name="skills" rows="4" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="List professional skills, technical abilities, etc."><?php echo htmlspecialchars($youth['skills']); ?></textarea>
                            </div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea id="interests" name="interests" rows="4" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="List personal interests, hobbies, etc."><?php echo htmlspecialchars($youth['interests']); ?></textarea>
                            </div>
                ...
                <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea id="admin_notes" name="admin_notes" rows="4" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Internal notes for administrators only"><?php echo htmlspecialchars($youth['admin_notes']); ?></textarea>
                            </div>
            ...
            <div class="flex justify-end">
                <a href="index.php" class="py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mr-3">Cancel</a>
                <button type="submit" class="py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Create Record</button>
            </div>
        </form>
    </main>
</div>
