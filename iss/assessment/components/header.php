...
function renderAdminHeader($pageTitle, $pageDescription = '', $actionButtons = [])
{
    ...
    $userRole = $_SESSION['user_role'] ?? 'assessment';
    $roleNames = [
        'assessment' => 'Assessment Team',
        'lead_assessor' => 'Lead Assessor',
        'admin' => 'Administrator'
    ];
    $roleAbbr = $roleNames[$userRole] ?? 'ASSESSOR';
?>
    ...
    <header class="bg-white border-b border-gray-200 shadow-sm">
        <div class="px-4 py-4 sm:px-6 flex items-center justify-between">
            <div class="flex items-center">
                ...
                <button id="sidebarToggle" class="lg:hidden mr-3 w-8 h-8 flex items-center justify-center text-gray-700 hover:text-purple-700 hover:bg-purple-50 rounded-lg transition-colors">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="hidden sm:inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-900 text-white">
            ...
            <div class="flex items-center space-x-2 sm:space-x-4">
                ...
                <div class="relative">
                    <button id="adminMenuToggle" class="flex items-center space-x-2 px-2 py-2 text-sm text-gray-600 hover:text-purple-700 hover:bg-purple-50 rounded-lg transition-colors">
                    ...
                    <div id="adminDropdown" class="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-200 py-1 z-50 opacity-0 invisible transform scale-95 transition-all duration-200 ease-out">
                        ...
                        <?php if (!empty($actionButtons)) : ?>
                            <div class="border-b border-gray-100">
                                ...
                                ?>
                                    <a href="<?php echo $href; ?>" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-purple-50 hover:text-purple-700 transition-colors <?php echo $shouldShow; ?>">
                                        <?php if ($icon) : ?>
                        ...
                        <a href="../profile/" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-purple-50 hover:text-purple-700 transition-colors">
                            <i class="fas fa-user-circle w-4 h-4 mr-3"></i>
                            Profile Settings
                        </a>
                        <a href="../audit/" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-purple-50 hover:text-purple-700 transition-colors">
                            <i class="fas fa-shield-alt w-4 h-4 mr-3"></i>
                            Audit Logs
                        </a>
                        <a href="../settings/" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-purple-50 hover:text-purple-700 transition-colors">
