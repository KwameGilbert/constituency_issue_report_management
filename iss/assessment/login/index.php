...
<head>
    ...
    <title>Assessment Team Login - Constituency System</title>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                // Send login request
                fetch('assessment_login_ajax.php', {
                        method: 'POST',
                        body: formData
                    })
                    ...
                    .then(data => {
                        ...
                        btnText.textContent = 'Access Assessment Portal';
...
<body class="min-h-screen bg-gray-50 font-inter antialiased">
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 xl:w-3/5 bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 relative overflow-hidden">
            <!-- Background Pattern -->
            ...
            <div class="relative z-10 flex flex-col justify-center px-12 py-12 text-white">
                <div class="max-w-md">
                    ...
                    <p class="text-xl text-purple-100 mb-8 leading-relaxed">
                        Stakeholder assessment team access for comprehensive issue evaluation and recommendations.
                    </p>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="text-purple-100">Issue assessment and review</span>
                        </div>
                        <div class="flex items-center space-x-3">
                            <div class="w-2 h-2 bg-purple-300 rounded-full"></div>
                            <span class="text-purple-100">Detailed recommendations</span>
                        </div>
                        <div class="flex items-center space-x-3">
                            <div class="w-2 h-2 bg-purple-300 rounded-full"></div>
                            <span class="text-purple-100">Collaborative workflow</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Decorative Elements -->
            <div class="absolute top-1/4 right-0 w-64 h-64 bg-purple-500/20 rounded-full blur-3xl transform translate-x-32"></div>
        ...
        <div class="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-8 xl:px-12">
            <div class="mx-auto w-full max-w-md">
                ...
                <div class="lg:hidden text-center mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900">Assessment Portal</h2>
                    <p class="text-gray-600 mt-2">Stakeholder Assessment Team</p>
                </div>

                <!-- Desktop Header -->
                <div class="hidden lg:block mb-8">
                    <h2 class="text-3xl font-bold text-gray-900">Assessment Portal</h2>
                    <p class="mt-2 text-gray-600">Sign in to your assessment team account</p>
                </div>
                ...
                <form id="loginForm" class="space-y-6">
                    ...
                    <button type="submit" id="loginBtn"
                        class="w-full flex justify-center items-center py-3 px-4 border border-transparent
                               rounded-xl shadow-sm text-base font-medium text-white bg-purple-600
                               hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2
                               focus:ring-purple-500 transition duration-200 ease-in-out">
                        ...
                        <span id="btnText">Access Assessment Portal</span>
                    </button>
                </form>
